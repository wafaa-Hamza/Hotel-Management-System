...
<template>
  <div>
    ...
    <VCol cols="12" md="12">
      <VCard class="d-print-none">
        ...
        <div style="display: flex;width: 55%;justify-content: space-between;float: inline-end;">
          ...
          <VCol>
            <VBtn @click="getPayment" style="float: inline-end;">
              {{ $t('Search') }}
            </VBtn>
          </VCol>
          <VCol>
    ...
    <VCard v-show="Visability" style="padding-bottom: 2%;" id="html-content">
      <br>
          ...
          <VCol cols="12" sm="12" md="12">
            ...
            <VCol style="padding: 2px;" cols="12" sm="12" md="12">
              <table style=" width: 100%;  color: black;font-size: 12px;">
                ...
                <tbody>
                  <tr v-for="(item, itemObjKey) in PaymentVoucher" :key="itemObjKey"  style="height: 20px;text-align: center">
                    <td style="border-bottom: 1px solid;"> {{ item.transaction_collection }}</td>
                  ...
                  <tr v-if="dataCount > 0">
                    <td style="box-shadow: 0 5px 8px 0;">
                    ...
                    <td></td>
                    <td></td>
                    <td style="box-shadow: 0 5px 8px 0;text-align: center;">Sum payment =>
                      <b>{{ parseFloat(SumsPayment).toFixed(3) }}</b></td>
                  </tr>
                </tbody>
              </table>
            </VCol>
  ...
  methods: {
    getPayment() {
      axios.post(`${this.URL}/api/payment-voucher-list-report`, {
        ...
        this.PaymentVoucher.forEach((ele, value) => { this.SumsPayment += ele.charge_amount })))
