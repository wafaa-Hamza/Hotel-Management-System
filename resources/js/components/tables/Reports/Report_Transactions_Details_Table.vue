      ...
      <VCard class="d-print-none">
        ...
        <div
          ...
          <VCol>
            ...
            <VCombobox v-model="ledgers_id" :items="Ledgers" :label="$t('Ledger id')" item-title="name" multiple
            ...
            <VCol cols="12" sm="12" md="12">
              ...
              <VCol style="padding: 2px;" cols="12" sm="12" md="12">
                ...
                <table style=" width: 100%;  color: black;font-size: 12px;">
                  ...
                  <tbody>
                    <tr v-for="item in Details" class="text-center" style="height: 20px;">
                      ...
                      <td style="border-bottom: 1px solid;">{{ item.charge_amount == null ? item.payment_amount :
                        item.charge_amount }}</td>
                    ...
                    <br>
                    <tr>
                      <td v-if="dataCount > 0" style="text-align: center;">
...
export default {
  ...
  methods: {
    ...
    getDetails() {
      axios.post(`${this.URL}/api/transactions-details`, {
        start_date: this.start_dates,
        end_date: this.end_dates,
        ledger_id: this.ledgers_id.map(ele => ele.id)
      }).then(res => (this.Details = res.data.data.transactions_details, this.dataCount = res.data.data.transactions_details.length, this.tot_sum_charge = res.data.data.tot_sum_charge
        // this.Details.forEach((value, index)=>{this.SumsCharge+=value.charge_amount,this.SumsPayment+=value.payment_amount})
      ))
