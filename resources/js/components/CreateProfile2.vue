...
export default {
  ...
  // eslint-disable-next-line vue/component-api-style
  methods: {
    emitSelectProfile(item) {
      // eslint-disable-next-line vue/custom-event-name-casing
      this.$emit('select-profile', item)
    ...
    showGuestProfile() {
     ...
     this.$emit('show-profile')
      ...
      console.log('guestFromParent',this.guestFromParent)
      if (this.guestFromParent == null || this.guestFromParent == "") {
        this.isSnackbarVisible = true
        this.profiledetailsDialog = false
      } else {
        this.first_name = this.guestFromParent.first_name
        this.last_name = this.guestFromParent.last_name
        this.id_number = this.guestFromParent.id_number
        this.gender = this.guestFromParent.gender
        this.mobile = this.guestFromParent.mobile
        this.phone = this.guestFromParent.phone
        this.email = this.guestFromParent.email
        this.city = this.guestFromParent.city
        this.address = this.guestFromParent.address
        this.country = this.guestFromParent.country.name
        this.language = this.guestFromParent.language
        this.select_day = this.guestFromParent.date_of_birth.slice(8, 10)
        this.select_month = this.guestFromParent.date_of_birth.slice(5, 7)
        this.select_year = this.guestFromParent.date_of_birth.slice(0, 4)
