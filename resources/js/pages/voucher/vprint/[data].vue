  ...
  <div style="padding: 2%;">
    ...
    <VRow>
      ...
      >
        ...
        <hr class="my-1">
        <VCard style="display: flex;justify-content: space-around;padding: 3%;text-align: center;">
          <div style="width: 65%;">
            <h2 style="display: inline;">
              {{ $t('Copy of TAX Invoice') }}
            </h2>

            <h3 style="display: inline;width: 50px;height: 50px;padding: 2% 4%;margin: 0 2%;background: black;color: white;">
              {{ AllVoucher.trans_no }}
            </h3>
          </div>
          <div style="width: 25%;">
