...
const buyNowUrl = ref(vm?.appContext.config.globalProperties.buyNowUrl || 'https://masasoft.net')
...
<template>
  <VBtn id="buy-now-btn" color="error" class="product-buy-now" :href="buyNowUrl" target="_blank"
